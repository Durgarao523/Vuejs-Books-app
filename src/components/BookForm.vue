<template>
  <form v-on:submit.prevent="bookSubmit(bookData)" class="" action="#" method="post">
	...
	<label for="borrowed">borrowed</label><input v-model="bookData.ownership" value="borrowed" type="radio"/>
	<label for="bought">bought</label><input v-model="bookData.ownership" value="bought" type="radio"/>
	</div>
